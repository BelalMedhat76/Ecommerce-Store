...
//     // Fetch products from Firestore on initial load
//     useEffect(() => {
...
//         // After adding, update the products state to reflect the new product
//         const newProductWithId = { id: docRef.id, ...newProduct };
...
//     // Delete product from Firestore and update local state
...
//       {/* Add Product Form */}
//       <div className="add-product-form mb-6 flex items-center space-x-4" >
//         <input
//           type="text"
...
//       {/* Product List */}
//       <ul className="product-list space-y-4">
//         {products.map((product) => (
//           <li
//             key={product.id}
//             className=" p-4 bg-gray-100 border border-gray-300 rounded  shadow  addingProductContent"
//           >
//      <div className="leftContent">
//      <span className="text-gray-800 font-medium">
//                 <span className="TitleHead"> Name :  {""}  </span>
//                 {product.name}
//             </span>
//             <span className="text-gray-800 font-medium">
